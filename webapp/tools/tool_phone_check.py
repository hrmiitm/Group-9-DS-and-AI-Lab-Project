"""
tools/tool_phone_check.py
Phone number validation, formatting, carrier and region lookup.
...
from tools.tools_config import DEFAULT_PHONE_REGION


def check_phone_number(phone: str, region: str | None = None) -> dict:
    """
    ...
    region = region or DEFAULT_PHONE_REGION
